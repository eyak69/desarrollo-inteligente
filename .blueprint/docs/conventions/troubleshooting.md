...
Utilizar esta sección para registrar vulnerabilidades de seguridad, CVEs de alta severidad (CVSS ≥ 7.0), bugs críticos o breaking changes que afecten al stack de dependencias del proyecto. Correr el protocolo de `@blueprint-watchdog` para auditar periódicamente.

---

### [Tecnología / Paquete] — [Título breve del issue]

**Severidad:** CVE CVSS X.X / Breaking / Bug crítico  
**Versiones afectadas:** X.X.X – X.X.X  
**Versión instalada:** X.X.X  
**Estado:** Afectado / No afectado / Mitigado  
**Fuente oficial:** [URL exacta del advisory o release]  

**Descripción:**  
Breve descripción de qué falla, bajo qué condiciones y cómo afecta al sistema.

**Mitigación:**  
- Acción concreta 1 (ej: actualizar dependencia a versión X.X.X).
- Workaround temporal si la actualización directa no es viable de forma inmediata.
